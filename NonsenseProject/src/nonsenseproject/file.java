...
public class file implements org.apache.thrift.TBase<file, file._Fields>, java.io.Serializable, Cloneable, Comparable<file> {
  ...
  public java.nio.ByteBuffer buf; // required
  ...
  public java.nio.ByteBuffer bufferForBuf() {
    return org.apache.thrift.TBaseHelper.copyBinary(buf);
  }

  public file setBuf(byte[] buf) {
    this.buf = buf == null ? (java.nio.ByteBuffer)null : java.nio.ByteBuffer.wrap(buf.clone());
    return this;
  }

  public file setBuf(java.nio.ByteBuffer buf) {
    this.buf = org.apache.thrift.TBaseHelper.copyBinary(buf);
    return this;
  }
    ...
    case BUF:
      if (value == null) {
        ...
        if (value instanceof byte[]) {
          ...
          setBuf((java.nio.ByteBuffer)value);
        }
      }
      break;
        ...
        switch (schemeField.id) {
          ...
          case 2: // TYPE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.type = nonsenseproject.filetype.findByValue(iprot.readI32());
